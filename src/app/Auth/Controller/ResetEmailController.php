...
use YukataRm\Randomizer\Proxy\Randomizer;
...
abstract class ResetEmailController extends FormController
{
     ...
     * @var string
     */
    protected string $storeTokenWithErrorsKey = "form";
     ...
     * @var string
     */
    protected string $sendEmailWithErrorsKey = "form";
     ...
     * @var string
     */
    protected string $sendEmailWithErrorsMessageKey = "reset-email.failure.send-email";
     ...
     * @var string
     */
    protected string $withKey = "auth.reset-email";
