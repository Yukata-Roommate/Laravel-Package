...
abstract class ResetEmailTokenController extends FormController
{
     ...
     * @var string
     */
    protected string $failedFindTokenWithErrorsKey = "form";
     ...
     * @var string
     */
    protected string $expiredTokenWithErrorsKey = "form";
     ...
     * @var string
     */
    protected string $failedResetEmailWithErrorsKey = "form";
