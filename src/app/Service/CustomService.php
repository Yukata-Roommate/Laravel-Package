...
abstract class CustomService extends BaseService
{
    ...
    {
        return $this->successRedirectBack(__("yukata-rm::alert.success.store"));
    }
    ...
    {
        return $this->successRedirectBack(__("yukata-rm::alert.success.update"));
    }
    ...
    {
        return $this->successRedirectBack(__("yukata-rm::alert.success.delete"));
    }
    ...
    {
        return $this->failureRedirectBack($input, __("yukata-rm::alert.failure.store"));
    }
    ...
    {
        return $this->failureRedirectBack($input, __("yukata-rm::alert.failure.update"));
    }
    ...
    {
        return $this->failureRedirectBack($input, __("yukata-rm::alert.failure.delete"));
    }
    ...
    {
        return $this->failureRedirectBack($input, __("yukata-rm::alert.failure.fetch"));
    }
}
