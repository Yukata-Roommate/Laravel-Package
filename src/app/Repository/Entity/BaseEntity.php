...
abstract class BaseEntity extends ObjectEntity implements EntityInterface
{
     ...
     * constructor
     *
     * @param \YukataRm\Laravel\Interface\Repository\ModelInterface $model
     */
     ...
     *
     * @param string $name
     * @return \Illuminate\Support\Collection<\YukataRm\Laravel\Interface\Repository\ModelInterface>|null
     */
     ...
     *
     * @param string $name
     * @return \Illuminate\Support\Collection<\YukataRm\Laravel\Interface\Repository\EntityInterface>|null
     */
