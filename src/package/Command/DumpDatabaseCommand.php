...
class DumpDatabaseCommand extends BaseCommand
{
    ...
    protected function getConfigProperty(string $property): mixed
    {
        ...
        if (!isset($connections[$this->connection])) throw new \InvalidArgumentException("connection not found: {$this->connection}");
    ...
    protected function setDumper(): void
    {
        ...
        if (is_null($this->dumper)) throw new \InvalidArgumentException("unsupported connection: {$this->connection}");
    }
