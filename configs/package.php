...
return [
    ...
    "log" => [
        ...
        "file"           => [
            ...
            "mode"        => env("YR_LOG_FILE_MODE", 0666),
            "owner"       => env("YR_LOG_FILE_OWNER", null),
            "group"       => env("YR_LOG_FILE_GROUP", null),
        ],
        ...
        "query" => [
            ...
            "logging" => [
                ...
                "file"           => [
                    ...
                    "mode"        => env("YR_LOGGING_QUERY_FILE_MODE", 0666),
                    "owner"       => env("YR_LOGGING_QUERY_FILE_OWNER", null),
                    "group"       => env("YR_LOGGING_QUERY_FILE_GROUP", null),
                ],
            ],
        ],
    ],
